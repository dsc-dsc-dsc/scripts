...
VARIABLES
  ...
  mpd_format    The text to display (/me is now playing %%ARTIST - %%TITLE)
...
Irssi::settings_add_str('mpd', 'mpd_format', '/me is now playing 10%ARTIST 9"%ALBUM" 02(%DATE)0 - 7%TITLE');
